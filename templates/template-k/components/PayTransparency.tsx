...
export default function PayTransparency({ heading, subheading, benefits, image }: PayTransparencyProps) {
  return (
      ...
      <div className="max-w-[1230px] mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {image && (
            ...
            >
              <img src={image} alt="Pay transparency" className="w-full h-[480px] object-cover" />
            </motion.div>
          )}
