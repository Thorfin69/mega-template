...
export const TEMPLATES: TemplateMetadata[] = [
  ...
  {
    id: 'template-o',
    displayName: 'BrandBooster — Lead Generation Agency',
    route: '/template-o',
    accentColor: '#ea480f',
    bgStyle: 'mixed',
    industries: ['marketing', 'lead-generation', 'advertising', 'local-seo', 'ppc', 'digital-marketing', 'home-services', 'contractors', 'plumbers', 'roofers', 'lawyers'],
    keywords: ['bold', 'conversion-focused', 'agency', 'pricing-table', 'testimonials', 'faq', 'awards', 'local-business', 'roi-focused'],
    complexity: 'complex',
    swapHours: 3,
    previewImage: '/templates/template-o/preview/hero.png',
    claudeMdPath: '/templates/template-o/CLAUDE.md',
    contentMdPath: '/templates/template-o/CONTENT.md',
    designMdPath: '/templates/template-o/DESIGN.md',
  },
];
